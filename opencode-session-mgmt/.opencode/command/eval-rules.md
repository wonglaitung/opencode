---
description: 运行规则遵循度评测基线（eval-rules，设计文档 13.1；需真实模型端点，不随 bun test 跑）
---
...
环境变量与完整操作手册（冻结 46 场景基线 / 三级验证 / 质量飞轮五维 delta / 改评分标准 → 评测迭代）见 `.opencode/skills/workflow-rules-eval/SKILL.md`。
