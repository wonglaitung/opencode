...
- 设计文档任何行为变更须同步更新对应 mermaid 流程图（三个设计文档合计 22 个：session-management.md 18 个、workflow-reqdoc.md 4 个、workflow-sdlc.md 0 个；新增图块须整体搬入对应文档族文件，总数只减不增），改链路必改图。
