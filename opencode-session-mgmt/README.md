...
- **设计文档族**：[`docs/session-management.md`](docs/session-management.md)（通用机制 / 架构 / CLI / 统计 / 部署 / 评测，主文档）、[`docs/workflow-sdlc.md`](docs/workflow-sdlc.md)（工作流一：sdlc 定义与规则）、[`docs/workflow-reqdoc.md`](docs/workflow-reqdoc.md)（工作流二：reqdoc 定义与规则）
